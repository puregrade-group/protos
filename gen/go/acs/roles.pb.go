...
func (x *ReadRoleOwnersResponse) GetUserIds() []string {
	if x != nil {
		return x.UserIds
	}
	return nil
...
func (x *CheckRolesRequest) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
var file_acs_roles_proto_rawDesc = []byte{
	...
	0x6d, 0x2f, 0x70, 0x75, 0x72, 0x65, 0x67, 0x72, 0x61, 0x64, 0x65, 0x2d, 0x67, 0x72, 0x6f, 0x75,
	0x70, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x3b, 0x61, 0x63, 0x73, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
